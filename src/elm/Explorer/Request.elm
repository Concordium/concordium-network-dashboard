...
updateQueuesDecoder =
    D.succeed UpdateQueues
        ...
        |> required "poolParameters" (updateQueueDecoder (D.oneOf [ poolParametersV1Decoder
                                                                 , poolParametersV0Decoder ]))
        |> required "cooldownParameters" (updateQueueDecoder (D.oneOf [ cooldownParametersV1Decoder
